...
def home():
    ...
    return render_template("index.html", recetas = response)
...
def recetasXEtiquetas():
    ...
    response = json.loads(response)
    print(response)
    return render_template("topTags.html", recetas = response)
...
def sort():
    ...
    response = json_util.dumps(recetas)
    response = json.loads(response)
    return render_template("sort.html",  recetas = response)
...
def topComment():
    ...
    response = json_util.dumps(recetas)
    response = json.loads(response)
    return render_template("TopComments.html", recetas = response)
...
def topPuntuaciones():
    ...
    response = json_util.dumps(recetas)
    response = json.loads(response)
    return render_template("TopPuntuaciones.html", ecetas = response)
...
def filter():
    ...
    if(data.get("receta") != ""):
        ...
        return render_template("index.html", recetas = rsp)
